...
namespace AutoScanFQCTest.DataModels
{
    ...
    public class MESTrayInfo
    {
        ...
        public Dictionary<string, MesAIProductInfoSZ> m_dictionary_barcode_with_mesAIProductInfoSZ;
        public Dictionary<string, MesAIProductInfoYC> m_dictionary_barcode_with_mesAIProductInfoYC;
        ...
        public void init_data(TrayInfo tray_info)
        {
            ...
            m_dictionary_barcode_with_mesAIProductInfoSZ = new Dictionary<string, MesAIProductInfoSZ>();
            m_dictionary_barcode_with_mesAIProductInfoYC = new Dictionary<string, MesAIProductInfoYC>();
    ...
    public class PointPosInfoYC
    {
        [JsonPropertyName("side_A")]
        public Side side_A { get; set; }

        [JsonPropertyName("side_B")]
        public Side side_B { get; set; }
    }
