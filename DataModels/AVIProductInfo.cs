...
namespace AutoScanFQCTest.DataModels
{
    ...
    {
        // 序列化产品信息
        public static string SerializeProductInfo(AVIProductInfo productInfo)
        {
            return JsonSerializer.Serialize(productInfo, new JsonSerializerOptions { WriteIndented = true });
        }

        // 反序列化产品信息
        public static AVIProductInfo DeserializeProductInfo(string json)
        {
            return JsonSerializer.Deserialize<AVIProductInfo>(json);
        }
    }
